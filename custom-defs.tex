...
\usepackage[backend=biber,
	...
	style=authoryear,
	maxcitenames=2,
	maxbibnames=4, % keep poster references compact and readable
	minbibnames=3,
...
%% Compact bibliography marker for poster-scale references
\setbeamertemplate{bibliography item}{\raisebox{0.25ex}{\scriptsize\textbullet}}
...
%	left=0mm,right=0mm,top=2mm,bottom=0mm,
	title={#1},
	fonttitle=\bfseries\large, fontupper=\color{cyan!65!black},
...
%	left=0mm,right=0mm,top=2mm,bottom=0mm,
	title={#1},
	fonttitle=\bfseries\large, fontupper=\color{brown!65!black},
