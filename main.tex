		...
		\begin{column}{\colwidth}
		  ...
		  \end{exampleblock}
			...
			\begin{block}{Conclusion and Next Steps}
				A2C2 does not improve Task 1 under the current configuration, reducing mean
				$q_{final}$ from * to *. The next iteration should focus on making
			...
			\begin{block}{References}
				\scriptsize
				\nocite{Li2024Behavior1K}
				\nocite{Bai2025OpenPIComet}
				\nocite{Black2025Pi0}
				\nocite{Sendai2025LeaveNoObservation}
